...
const QUERY_KEY = ['settings', 'service-categories']
const API_URL = '/api/v1/settings/service-categories'
...
export default function ServiceCategoriesPage() {
  ...
  const { data, isLoading } = useQuery({
    queryKey: QUERY_KEY,
    queryFn: () => apiFetch<ServiceCategory[]>(API_URL),
  })
    ...
    <div className="space-y-6">
      <div className="flex items-center gap-2">
        ...
        <div>
          ...
          <p className="text-muted-foreground text-sm">Organize your services into categories</p>
        </div>
      </div>
